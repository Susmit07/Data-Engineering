...
stage_events_to_redshift = StageToRedshiftOperator(
    ...
    # redshift, udacity-dend, aws_credentials VARIABLE under the connection in Airflow UI
    redshift_conn_id="redshift",
    aws_credentials_id="aws_credentials",
    s3_bucket="udacity-dend",
    # all files under log_data directory
    s3_key="log_data",
    region="us-west-2",
...
stage_songs_to_redshift = StageToRedshiftOperator(
    ...
    aws_credentials_id="aws_credentials",
    s3_bucket="udacity-dend",
    # all files under song_data directory
    s3_key="song_data",
    region="us-west-2",
...
# Will be generic for all tables.
...
# Loading done starting with quality checks.
