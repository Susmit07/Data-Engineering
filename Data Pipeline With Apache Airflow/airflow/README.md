...
The source data resides in S3 and needs to be processed in Sparkify's data warehouse in AWS Redshift. The source datasets consist of JSON logs that tell about user activity in the application and JSON metadata about the songs the users listen to.
...
1. AWS credentials named aws_credentials.
2. Connection to Redshift named redshift.
3. udacity-dend s3 Bucket variable.